  ...
  return (
    <StaticPage title="Contact Us" subtitle="We usually respond within one business day.">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <a href="tel:+919894274168" className="flex items-start gap-3 rounded-2xl border border-border bg-white p-4 hover:border-brand-orange/40">
          <Phone className="h-5 w-5 shrink-0 text-brand-orange" />
          <span>
            <span className="block text-sm font-semibold text-foreground">Phone</span>
            <span className="block text-xs text-muted-foreground">+91 98942 74168</span>
          </span>
        </a>
